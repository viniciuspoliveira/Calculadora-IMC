...
struct CalculatorBrain{
    ...
    mutating func calculateIMC(altura: Float, peso: Float){
        ...
        if imcValue < 18.5{
            ...
            imc = IMC(value: imcValue, advice: "Muito bem! Quase um atleta heim!", color: #colorLiteral(red: 0, green: 0.4588235294, blue: 0.8901960784, alpha: 1))
            
        } else {
            imc = IMC(value: imcValue, advice: "Vamos diminuir o salgadinho?", color: #colorLiteral(red: 0.521568656, green: 0.1098039225, blue: 0.05098039284, alpha: 1))
        }
